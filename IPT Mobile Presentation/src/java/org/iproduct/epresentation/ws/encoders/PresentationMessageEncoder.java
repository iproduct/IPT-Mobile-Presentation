...
package org.iproduct.epresentation.ws.encoders;
 ...
 * encoder to string value  
 *
 * @author Trayan Iliev
 */
public class PresentationMessageEncoder implements Encoder.Text<PresentationMessage> {

    @Override
    public String encode(PresentationMessage message) throws EncodeException {
